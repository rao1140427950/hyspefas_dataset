...
import torch
from utils.dataset import SSIDataset
from torch.utils.data import DataLoader
from fas_models.ssi_models.smn_resnet import SMN_ResNet18_ as Net
...
def train(Model=Net, name='smn-resnet', verbose=1, batch_size=60, do_validation=True, protocol=1,
